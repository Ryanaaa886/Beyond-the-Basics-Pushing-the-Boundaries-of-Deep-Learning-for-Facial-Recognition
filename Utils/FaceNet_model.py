...
def _conv_block(inputs, filters, kernel=(3, 3), strides=(1, 1)):
    """
    Convolution block in MobileNet backbone.
    """
...
def _depthwise_conv_block(inputs, pointwise_conv_filters, depth_multiplier=1, strides=(1, 1), block_id=1):
    """
    Depthwise convolution block in MobileNet backbone
    """
...
def FaceNet(input_shape, 
    ...
    try:
        ...
        raise ValueError('Unsupported backbone ! Please use mobilenet.')

    if mode == "train":
        #--------------------------------------------#
        # if use train mode, 
        # model applies triplet loss and cross entropy to train
        #--------------------------------------------#
